			...
			$('.btn').on('click', function(e){
				...
				$.get('http://weixin.cloudliving.net/community_service.php?c=Index&a=act&action=join_act&id='+hash.id+'&linkman='+name+'&phone='+phone, {uid:uid},function(data){
					...
					if (fee == 0) {
						...
						location.href = ('http://weixin.cloudliving.net/index.php?m=CAPI&c=Index&a=index&id='+id+'&uid='+uid)
					}
				...
				// } else {
				// 	// location.href = 'http://weixin.cloudliving.net/index.php?m=CAPI&c=Index&a=index&id='+id
				// 	location.href = ('http://weixin.cloudliving.net/index.php?m=CAPI&c=Index&a=index&id='+id+'&uid='+118330)
